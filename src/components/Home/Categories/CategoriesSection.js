...
const CategoriesSection = () => {
  return (
    <div className="flex flex-col px-4 py-4 md:px-8 lg:px-12">
      <div className="py-12">
        <p className="pl-20 md:pl-28 font-GilroyBold text-3xl lg:text-5xl text-darkPrimary relative before:content-[''] before:absolute before:w-16 md:before:w-24 before:bg-secondary before:h-1 before:top-4 lg:before:top-6 before:left-0">
      ...
      <div className="flex flex-wrap items-center">
        <div className="basis-full lg:basis-1/2 mb-8 lg:mb-0 px-4 lg:px-0">
          <div className="relative flex justify-center">
            <img
              className="w-full h-[20rem] md:h-[27rem] xl:h-[34rem]"
